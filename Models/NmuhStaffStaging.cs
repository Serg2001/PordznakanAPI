...
{
    /// <summary>
    /// Staging copy of nmuh staff schema used for MD5-based sync.
    /// </summary>
    public class NmuhStaffStaging
    {
        public Guid Id { get; set; }
        public string NmuhStaffId { get; set; } = string.Empty;          // staff_id from external API
