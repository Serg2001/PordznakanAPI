...
namespace PordznakanAPI.Controllers
{
    ...
    public class LogStudentController : ControllerBase
    {
        ...
        private const string SourceBaseUrl = "https://api.emis.am/v1/dshh_log_students";

        public LogStudentController(ILogTransferService logTransferService)
        {
            _logTransferService = logTransferService;
        }

        private static LogStudent MapToModel(JObject o, DateTime fallbackDate)
        {
        ...
        public Task ProcessAllRegions() =>
            _logTransferService.ProcessAllRegionsAsync(SourceBaseUrl, nameof(LogStudent), MapToModel);
