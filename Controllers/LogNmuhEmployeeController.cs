...
namespace PordznakanAPI.Controllers
{
    ...
    public class LogNmuhEmployeeController : ControllerBase
    {
        ...
        private const string SourceBaseUrl = "https://api.emis.am/v1/dshh_log_nmuh_emploee";

        public LogNmuhEmployeeController(ILogTransferService logTransferService)
        {
            _logTransferService = logTransferService;
        }

        private static LogNmuhEmployee MapToModel(JObject o, DateTime fallbackDate)
        {
